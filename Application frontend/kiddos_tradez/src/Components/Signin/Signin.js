...
function Signin({ setUserState, setIsSignedUp }) {
  ...
  const validateForm = (values) => {
    ...
    if (!values.confirmpassword) {
      ...
      error.confirmpassword =
        "Confirmed password and password should be the same";
    }
      ...
      axios
        ...
        .then((res) => {
          if (res && res.data) {
            ...
            console.log(res);
            console.log(" im the token", res.data[1].message.split(" ")[2]);
            localStorage.setItem("token", res.data[1].message.split(" ")[2]);
            ...
            localStorage.setItem("homeAddress", values.homeAddress);
            localStorage.setItem("phone", values.phone);
            localStorage.setItem("avgResponseTime", values.avgResponseTime);
